...
public class Evidence {
	...
	public int uniqueBugSeqNum; //Ordinal of the unique bug within its project; used by the optional unique-bug recency.
	...
	public Evidence(Date date, int seqNum, int uniqueBugSeqNum, int[] virtualSeqNum, int freq, int totalNumberOfWordsInThisEvidence, BTOption3_TF option3_TF){
		this.date = date;
		this.bASeqNum = seqNum;
		this.uniqueBugSeqNum = uniqueBugSeqNum;
