...
# Runtime path resolution for cross-platform compatibility
import os
_current_dir = os.path.dirname(os.path.abspath(__file__))
DATASET_DIRECTORY_BASE: str = _current_dir

DATASET_DIRECTORY_FOR_THE_ALGORITHM__GH__EXPERIMENT_MAIN: str = os.path.join(DATASET_DIRECTORY_BASE, "Exp", "In", "GH", "DSForMainExp")
DATASET_DIRECTORY_FOR_THE_ALGORITHM__GH__EXPERIMENT_TFIDF: str = os.path.join(DATASET_DIRECTORY_BASE, "Exp", "In", "GH", "DSForTFIDFExp")
DATASET_DIRECTORY_FOR_THE_ALGORITHM__SO__EXPERIMENT: str = os.path.join(DATASET_DIRECTORY_BASE, "Exp", "In", "SO")
DATASET_DIRECTORY_FOR_THE_ALGORITHM__EXPERIMENT_OUTPUT: str = os.path.join(DATASET_DIRECTORY_BASE, "Exp", "Out")
